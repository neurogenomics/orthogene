...
`orthogene` is now available via [DockerHub](https://hub.docker.com/repository/docker/bschilder/orthogene) 
...
```
docker pull bschilder/orthogene
```
...
```
singularity pull docker://bschilder/orthogene
```
