test_that("convert_orthologs works", {
  ...
  gene_df_std <- convert_orthologs(gene_df = exp_mouse_df, 
                                   input_species="mouse",
                                   gene_input="rownames",
                                   gene_output = "columns", 
  ...
  gene_df_converted <- convert_orthologs(gene_df = gene_df_std, 
                                         input_species="mouse",
  ...
  # tabular input 
  gene_dict <- convert_orthologs(gene_df = exp_mouse_df,
                                     input_species="mouse", 
                                     gene_output = "dict")
  ...
  # vector input 
  gene_dict_rev <- convert_orthologs(gene_df = rownames(exp_mouse_df)[seq(1,100)], 
                                     input_species="mouse", 
