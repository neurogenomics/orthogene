#' \code{orthogene} is an R package for easy mapping of
#' orthologous genes across hundreds of species.  
#' 
#' It pulls up-to-date interspecies gene ortholog
#'  mappings across 700+ organisms. 
#' 
...
#' \code{orthogene} was created by Brian M. Schilder.}  
#' }
#' .
"_PACKAGE"