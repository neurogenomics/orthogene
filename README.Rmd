...
[![R build status](https://github.com/neurogenomics/orthogene/workflows/DockerHub/badge.svg)](https://github.com/neurogenomics/orthogene/actions) 
...
`orthogene` can also be installed via a  [Docker](https://hub.docker.com/repository/docker/bschilder/orthogene) or [Singularity](https://sylabs.io/guides/2.6/user-guide/singularity_and_docker.html)
